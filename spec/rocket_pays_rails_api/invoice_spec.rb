...
RSpec.describe RocketPaysRailsApi::Invoice, type: :model do
  ...
  describe '#to_json' do
    let!(:product) { RocketPaysRailsApi::Product.new(description: 'Product 1', name: 'Product 1', unity_price: 100.0, quantity: 2) }
    let!(:product_two) { RocketPaysRailsApi::Product.new(description: 'Product 2', name: 'Product 2', unity_price: 100.98, quantity: 1) }
